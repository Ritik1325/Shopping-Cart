    ...
    return (
        <>
            <div className="min-h-screen flex  justify-center items-center bg-[url('/public/bgimage.png')] bg-cover bg-center" >
                ...
                <div className="max-w-lg h-[450px] px-4 py-4 border border-white/10 bg-white/10  flex flex-col rounded-2xl shadow-xl">
                    <h1 className=" px-6 py-6  text-3xl mb-6 font-medium text-blue-400 tracking-wide ">Login</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-center flex-col items-center">
                            ...
                            <button type="submit" className="p-4 w-92 rounded-xl bg-orange-500 text-white font-semibold text-xl hover:bg-orange-400 ">Login</button>
                        </div>
                    </form>
